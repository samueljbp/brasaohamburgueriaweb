    ...
    public class CadastrosRepository
    {
        ...
        public void RemoverLogoEmpresa(string serverPath, EmpresaViewModel empresa)
        {
            try
            {
                ...
                SessionData.RefreshParam(BrasaoSolution.Repository.SessionData.Empresas);
            ...
            using (var dbContextTransaction = _contexto.Database.BeginTransaction())
            {
                if (modoCadastro == "A") //alteração
                {
                    ...
                    if (empresaAlterar != null)
                    {
                        ...
                        empresaAlterar.UrlSite = empresa.UrlSite;

                        await _contexto.SaveChangesAsync();
                        dbContextTransaction.Commit();

                        BrasaoSolution.Repository.SessionData.RefreshParam(BrasaoSolution.Repository.SessionData.Empresas);
                    }
                ...
                else if (modoCadastro == "I") //inclusão
                {
                    ...
                    empresaIncluir.CasaAberta = "0";
                    empresaIncluir.UrlSite = empresa.UrlSite;

                    _contexto.Empresas.Add(empresaIncluir);
        ...
        public async Task<List<EmpresaViewModel>> GetEmpresas()
        {
            ...
            var lista = (
                ...
                where (SessionData.EmpresasInt.Contains(emps.CodEmpresa) || usuarioMaster)
        ...
        public async Task<ParametroSistemaViewModel> GravarParametroSistema(ParametroSistemaViewModel par, String modoCadastro, int codEmpresa)
        {
            if (modoCadastro == "A") //alteração
            {
                ...
                if (parAlterar != null)
                {
                    ...
                    await _contexto.SaveChangesAsync();
                    BrasaoSolution.Repository.SessionData.RefreshParam(BrasaoSolution.Repository.SessionData.ParametrosSistema);
                }
